...
void LCD_Init(void)
{
  ...
  GPIOA->ODR|=1<<1;      //PA.1
	...
	GPIOA->CRL|=0X00000300;//PA.2推挽输出	 
  GPIOA->ODR|=1<<2;      //PA.2
	
	GPIOA->CRL&=0XFFFF0FFF; 	
	GPIOA->CRL|=0X00003000;//PA.3推挽输出	 
  GPIOA->ODR|=1<<3;      //PA.3
	
//	GPIO_Set(GPIOG,PIN0|PIN1,GPIO_MODE_OUT,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU);
//	GPIO_Set(GPIOF,PIN14|PIN15,GPIO_MODE_OUT,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU);
	LCD_SCL=1;
	//LCD_CS=1;	//??SLK?SS????
...
{
	"北京龙丘邱科技开发板智能车首选液晶室温度按键次电压辽宁大学调试模式执行机械臂控制系统"
};
const unsigned char F14x16[] = {  
0x20,0x20,0x20,0x20,0xFF,0x00,0x00,0x00,0xFF,0x40,0x20,0x30,0x18,0x10,
0x30,0x18,0x08,0x04,0x7F,0x00,0x00,0x00,0x3F,0x40,0x40,0x40,0x40,0x78,//北
...
0x00,0x00,0x4C,0xC8,0x00,0x04,0x04,0x04,0xE4,0x14,0x0C,0x04,0x00,0x00,
0x00,0x20,0x10,0x0F,0x10,0x20,0x48,0x50,0x5F,0x40,0x40,0x40,0x00,0x00,//?25
0x00,0x00,0xB8,0x90,0x90,0x90,0x92,0x8C,0x90,0x90,0x90,0xF0,0x90,0x00,
0x00,0x00,0x00,0x00,0x00,0x40,0x60,0x1F,0x00,0x00,0x00,0x00,0x00,0x00,//?26
0x00,0x20,0x20,0x20,0x20,0x20,0xFE,0xA2,0x20,0x20,0x20,0x20,0x20,0x00,
0x00,0x80,0x40,0x20,0x10,0x0C,0x03,0x01,0x06,0x08,0x30,0x60,0x40,0x00,//?27
0x00,0x80,0x60,0xA4,0xB8,0xA0,0xA4,0xA8,0xA0,0xB8,0x26,0x60,0x20,0x00,
0x00,0x00,0x04,0x04,0x04,0x44,0x44,0x3E,0x05,0x04,0x04,0x04,0x04,0x00,//?28


0x00,0x40,0x42,0xCC,0x00,0x00,0xFC,0x04,0x94,0x7C,0x54,0x84,0xFC,0x00,
0x00,0x00,0x00,0x3F,0x48,0x38,0x07,0x1F,0x09,0x09,0x0E,0x40,0x3F,0x00,//?0
/* (14 X 16 , ?? )*/

0x00,0x80,0x8C,0x90,0x10,0x20,0x20,0x20,0xA0,0xFE,0x20,0x24,0x18,0x00,
0x00,0x00,0x00,0x7F,0x10,0x28,0x21,0x1F,0x10,0x09,0x0E,0x30,0x70,0x00,//?1
/* (14 X 16 , ?? )*/

0x00,0x00,0xD0,0xFE,0x90,0x18,0xE8,0xBE,0xA8,0xA8,0xBE,0xE8,0x00,0x00,
0x08,0x06,0x01,0x7F,0x88,0x88,0x4B,0x2A,0x1E,0x1A,0x2A,0x4B,0x4C,0x00,//?2
/* (14 X 16 , ?? )*/

0x00,0x00,0x90,0x90,0x10,0x90,0x90,0x10,0xFE,0x10,0x14,0x18,0x10,0x00,
0x00,0x60,0x20,0x20,0x1F,0x10,0x10,0x01,0x03,0x1C,0x20,0x40,0x70,0x00,//?3
/* (14 X 16 , ?? )*/

0x00,0x00,0x10,0xFE,0x90,0xB0,0x20,0xFE,0x20,0x20,0xF0,0x00,0x00,0x00,
0x00,0x02,0x41,0x7F,0x80,0x61,0x19,0x07,0x04,0x08,0x1F,0x20,0x70,0x00,//?4
/* (14 X 16 , ?? )*/

0x00,0x20,0x10,0xCC,0x30,0x40,0x40,0x44,0x44,0xC4,0x44,0x44,0x40,0x00,
0x00,0x02,0x01,0x7F,0x00,0x00,0x00,0x00,0x40,0x7F,0x00,0x00,0x00,0x00,//?5
/* (14 X 16 , ?? )*/
0x00,0x00,0xA0,0xFE,0xA0,0x00,0x00,0xF8,0x04,0x04,0xFC,0x00,0x00,0x00,
0x10,0x0C,0x03,0x7F,0x80,0x61,0x1E,0x01,0x00,0x00,0x7F,0x40,0x70,0x00,//机

0x00,0x00,0xFC,0x52,0x90,0x30,0xD0,0xF0,0x10,0xFE,0x10,0x14,0x98,0x00,
0x08,0x06,0x7F,0x00,0x41,0x3E,0x83,0x7F,0x21,0x13,0x1C,0x23,0x70,0x00,//械

0x00,0x80,0x7C,0xD4,0xB4,0xFC,0x20,0xA0,0xB8,0xE6,0xB8,0x64,0x20,0x00,
0x00,0x01,0x00,0x7F,0x1A,0x1B,0x1A,0x1A,0x5A,0x5B,0x7E,0x00,0x00,0x00,//臂

0x00,0x10,0x10,0xFE,0x90,0x20,0x90,0x50,0x14,0x0C,0x50,0xB0,0x18,0x00,
0x00,0x42,0x41,0x7F,0x00,0x01,0x42,0x42,0x3E,0x42,0x42,0x42,0x21,0x00,//控

0x00,0x60,0x58,0x50,0xFE,0x50,0x50,0x50,0x00,0xF8,0x00,0x00,0xFE,0x00,
0x00,0x1E,0x01,0x01,0x7F,0x11,0x31,0x0F,0x00,0x0F,0x40,0x40,0x3F,0x00,//制

0x00,0x00,0x00,0x44,0x64,0x54,0xCC,0x44,0x44,0xA2,0x12,0x02,0x00,0x00,
0x00,0x40,0x20,0x12,0x0F,0x0B,0x42,0x7E,0x02,0x0A,0x11,0x33,0x60,0x00,//系

0x00,0x60,0x50,0xCE,0x60,0x10,0x88,0x48,0x3A,0x8C,0x88,0xC8,0x88,0x00,
0x00,0x22,0x13,0x12,0x92,0x42,0x41,0x3D,0x03,0x00,0x7F,0x40,0x71,0x00,//统
...
const unsigned char hahah104x64[960] = 
{
,
};
...
void LCD_Rectangle(unsigned char x1,unsigned char y1,unsigned char x2,unsigned char y2,unsigned char gif)
{
	...
	{
		LCD_WrDat(0x01<<(y1%8));
		if(gif == 1) 	LCD_mDLY_ms(50);
	}
	LCD_Set_Pos(x1,y2>>3);
  for(n=x1;n<=x2;n++)
	{
		LCD_WrDat(0x01<<(y2%8));
		if(gif == 1) 	LCD_mDLY_ms(5);
	}
